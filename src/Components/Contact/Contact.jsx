        ...
        <div className="contact-left">
            ...
            <div className="contact-details">
                <div className="contact-detail">
                   <img src={mail_icon} alt="mail_icon" /> <p>jelenazekovic738@gmail.com</p>
                </div>
                 <div className="contact-detail"> 
                    <img src={call_icon} alt="call_icon" /> <p>+330-615-375-177</p>
                </div>
                 <div className="contact-detail">
                    <img src={location_icon} alt="location_icon" /> <p>France</p>
                </div>
            </div>
        </div>
